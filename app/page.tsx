...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Listen for logins and logouts instantly
  ...
  async function signInWithGoogle() {
    await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        // This tells Google where to send you back after logging in
      ...
      <div className="w-full max-w-md p-8 bg-gray-900 rounded-xl border border-gray-800 shadow-2xl text-center">
        ...
        {user ? (
          <div className="space-y-6">
            <h1 className="text-2xl font-bold text-green-400">You are in!</h1>
            <p className="text-gray-400">
              Welcome, {user.user_metadata?.full_name || 'Mysterious User'}
            </p>
            {/* Show their Google profile picture if it exists */}
